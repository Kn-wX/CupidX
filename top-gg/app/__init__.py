...
async def topgg():
    ...
    webhook_data = {
        ...
        "embeds": [
            {
                "description": "**[Voted CupidX](https://top.gg/bot/1421316948104577134)**\n💖 Thank you for voting for CupidX on Top.gg, your support means everything to us!\n",
                "fields": [
                ...
                "footer": {
                    "text": f"Voter ID: {user_id} | CupidX HQ | {footer_time}",

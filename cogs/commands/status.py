...
class Status(commands.Cog):
    ...
    async def status(self, ctx, user: discord.User = None):
        ...
        processing = await ctx.send("<a:CupidXloading:1474386958741536891> Loading Status...")
        embed = discord.Embed(title=f"{user.display_name}'s Status", color=0xFCD005)

        status_emoji = {
            "online": "<a:online:1465214381200637972> Online",
            "idle": "<a:idle:1465214627154755729> Idle",
            "dnd": "<a:dnd:1465214434430419026> Do Not Disturb",
            "offline": "<a:offline:1465214578119151763> Offline"
        }
        ...
        if member:
            status = status_emoji.get(str(member.status), "<:offline:1465214578119151763> Offline")
            ...
            try:
                ...
                embed.add_field(name="Status:", value="<:offline:1465214578119151763> Offline", inline=False)
    ...
    def get_platform(self, member):
        if member.desktop_status != discord.Status.offline:
            ...
            return "<:browser:1438566929324576889> Browser"
        return "Unknown"

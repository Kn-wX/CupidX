...
class Paginator(discord.ui.View):
    ...
    def update_styles(self, **kwargs) -> None:
        # Update the button emojis
        self.first_page_button.emoji = (
            kwargs.get("first_button_emoji") or "<:rewind1:1329360839874056225>"
        )
        self.previous_page_button.emoji = (
            kwargs.get("previous_button_emoji") or "<:next:1327829548426854522>"
        )
        self.next_page_button.emoji = (
            kwargs.get("next_button_emoji") or "<:icons_next:1327829470027055184>"
        )
        self.last_page_button.emoji = (
            kwargs.get("last_button_emoji") or "<:forward:1329361532999569439>"
        )
        self.stop_button.emoji = (
            kwargs.get("stop_button_emoji") or "<:delete:1327842168693461022>"
        )

        # Update the Button Styles
        self.first_page_button.style = (
            kwargs.get("first_button_style") or ButtonStyle.secondary
        )
        self.previous_page_button.style = (
            kwargs.get("previous_button_style") or ButtonStyle.secondary
        )
        self.stop_button.style = kwargs.get("stop_button_style") or ButtonStyle.red
        self.next_page_button.style = (
            kwargs.get("next_button_style") or ButtonStyle.secondary
        )
        self.last_page_button.style = (
            kwargs.get("last_button_style") or ButtonStyle.secondary
        )
    ...
    async def paginate(
        ...
        **kwargs,
        ...
        send_kwargs = await self._get_kwargs_from_page(page)

        if content:
            send_kwargs.setdefault("content", content)
